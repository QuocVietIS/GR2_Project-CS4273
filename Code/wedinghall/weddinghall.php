                        ...
                        <nav class="navbar navbar-default">
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="active"><a href=" Weddinghall.php">Wedding hall</a></li>
    ...
    <body>
        ...
        <article>
            ...
            <div>
                ...
                <a class="Sanh-1" href="">
                    <img style="width: 406px; height: 420px;"
                        src="https://cdn.glitch.me/0bce4a09-c806-418b-8506-6de60673f633%2FGroup%205.png?v=1638685603028">
                </a>
                <a class="Sanh-1-text">
                    Chứa: 50-80 bàn<br>
                    Giá: 1.200.000 VNĐ/Bàn
                </a>
                <a class="Sanh-2-main">
                    Sảnh 2
                </a>
                <a class="Sanh-2" href="">
                    <img style="width: 406px; height: 420px;"
                        src="https://cdn.glitch.me/0bce4a09-c806-418b-8506-6de60673f633%2FGroup%206.png?v=1638685932122">
                </a>
                <a class="Sanh-2-text">
                    Chứa: 40-70 bàn<br>
                    Giá: 1.400.000 VNĐ/Bàn
                </a>
                <a class="Sanh-3-main">
                    Sảnh 3
                </a>
                <a class="Sanh-3" href="">
                    <img style="width: 406px; height: 420px;"
                        src="https://cdn.glitch.me/0bce4a09-c806-418b-8506-6de60673f633%2FGroup%207.png?v=1638686102359">
                </a>
                <a class="Sanh-3-text">
                    Chứa: 50-80 bàn<br>
                    Giá: 1.200.000 VNĐ/Bàn
                ...
                <a class="Sanh-4" href="">
                    <img style="width: 406px; height: 420px;"
                        src="https://cdn.glitch.me/0bce4a09-c806-418b-8506-6de60673f633%2FGroup%208.png?v=1638686907922">
                </a>
                <a class="Sanh-4-text">
                    Chứa: 50-100 bàn<br>
                    Giá: 1.600.000 VNĐ/Bàn
                </a>
                <a class="Sanh-5-main">
                    Sảnh 5
                </a>
                <a class="Sanh-5" href="">
                    <img style="width: 406px; height: 420px;"
                        src="https://cdn.glitch.me/0bce4a09-c806-418b-8506-6de60673f633%2FGroup%2010.png?v=1638687001729">
                </a>
                <a class="Sanh-5-text">
                    Chứa: 50-100 bàn<br>
                    Giá: 1.800.000 VNĐ/Bàn
                </a>
            </div>
        </article>
    </body>
